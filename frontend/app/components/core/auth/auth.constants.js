(function() {
  ...
  angular
    ...
    .constant('TRANSLATE', {
      FR: {
        APP_LOGO: 'images/FIFA_World_Cup_2018_Logo.png',
        APP_NAME: 'PFS CDM 2018',
